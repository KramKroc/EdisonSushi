...
A massive thanks you to the **Edison folks** and **Michelle Miller** whose material this is entirely based on. The only addition here is to format it in the Coderdojo Sushi format so that it would have a familiar look and feel to the other Sushi cards that Dojo's may be using. 
